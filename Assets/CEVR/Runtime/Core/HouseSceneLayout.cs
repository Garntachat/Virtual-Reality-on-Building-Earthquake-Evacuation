...
{
    /// <summary>
    /// Measured ground-floor layout for the authored House ProBuilder scene.
    /// Coordinates come from HouseProBuilderLayoutAnalyzer rather than guessed room origins.
    ...
    public static class HouseSceneLayout
    {
        ...
        public static readonly Vector3 CoverObstacleChair = OnFloor(-1.90f, -4.15f);
        public static readonly Vector3 DiningLeftChair = OnFloor(-3.70f, -2.70f);
        public static readonly Vector3 DiningRightChair = OnFloor(-0.10f, -2.70f);
        public static readonly Vector3 SpareChair = OnFloor(-0.15f, -5.15f);
        ...
        public static readonly Vector3 Bed = OnFloor(-2.35f, 4.85f);
        public static readonly Vector3 BedPillow = OnFloor(-2.35f, 5.52f, 0.72f);
        ...
        // The south-wall opening was measured at x=-2.0, z=-7.5, above a solid sill.
        public static readonly Vector3 WindowCenter = new Vector3(-2.0f, 2.75f, -7.43f);
        public static readonly Vector3 WindowSize = new Vector3(1.05f, 1.55f, 0.06f);
