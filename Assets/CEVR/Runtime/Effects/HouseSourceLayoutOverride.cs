...
namespace ChulaEarthquakeVR
{
    ...
    public sealed class HouseSourceLayoutOverride : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("CEVR HOUSE SOURCE LAYOUT READY: legacy House dresser disabled; dining, TV, upstairs bed, ceiling hazards, and measured window created directly in House.");
        }
        ...
        private void BuildLivingRoom()
        {
            ...
            Kenney("rugRectangle", gameplayRoot, HouseSceneLayout.Rug + Vector3.up * 0.01f, new Vector3(2.5f, 0.02f, 3.0f), 90f, false);

            // Sofa sits west of the TV. +90 is the verified 180-degree correction from the old -90 yaw.
        ...
        {
            // Analyzer: upper walkable area x=4.25..6.25, z=0.25..3.0. Upper stair occupies
            // z>=1.5 while reaching x<=5.0. This bed footprint is entirely in z=0.28..1.13.
            Vector3 bedBottom = new Vector3(5.45f, HouseSceneLayout.SecondFloorY, 0.70f);
            Team("Bed", gameplayRoot, bedBottom, new Vector3(1.35f, 0.82f, 0.85f), 90f, true);
            Team("Bed_Pillow", gameplayRoot, new Vector3(5.78f, HouseSceneLayout.SecondFloorY + 0.51f, 0.70f),
        ...
        private void BuildMeasuredWindow()
        {
            ...
            // Exterior-ray audit: south wall has a sill at the low sample and an aperture across
            // x=-2.5,-2.0,-1.5 at the higher samples. Fit inside that opening, not over the wall.
            Vector3 center = new Vector3(-2.0f, 2.75f, -7.43f);
            Vector3 paneSize = new Vector3(1.42f, 1.50f, 0.045f);
